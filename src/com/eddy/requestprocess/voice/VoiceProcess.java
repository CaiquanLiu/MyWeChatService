package com.eddy.requestprocess.voice;
...
public class VoiceProcess implements IRequestProcess{
	...
	public void requestProcess(HashMap<String, String> request, HttpServletResponse response) {
		...
		String requestContent = request.get("Recognition");
		textMessage.setContent(process(requestContent));
